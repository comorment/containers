...
- add R libraries for LDpred2 analysis to `r.sif`
...
- removed ``ldsc.sif`` container, which is now included in its own GitHub repository (https://github.com/comorment/ldsc)
