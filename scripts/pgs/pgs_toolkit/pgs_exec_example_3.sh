...
python3 pgs_exec.py \
    ...
    --eigenvec-file output/PGS_synthetic_LDpred2_auto/g1000_eur_chr21to22_hm3rnd1.eigenvec \
    --file-geno-rds output/PGS_synthetic_LDpred2_auto/g1000_eur_chr21to22_hm3rnd1.rds \
